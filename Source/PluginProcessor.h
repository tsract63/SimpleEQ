...
public:
	...
	static juce::String paramLowCutBypassed;
	static juce::String paramPeakBypassed;
	static juce::String paramHighCutBypassed;
	static juce::String paramAnalyzerEnabled;
